...
import os
from cropping_lib.utils import create_mask, get_data
from cropping_lib.utils import get_bbox_names, check_working_dir
# %%
...
for idx in tqdm(box_data.index):
    ...
    im.save(BASEPATH + f'/cropping_data/check_boxes/' +
            box_data.loc[idx, 'Filename'])
